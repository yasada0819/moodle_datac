 ...
 */
class moodle1_mod_datac_handler extends moodle1_mod_handler {
     ...
     * defined.
     *
     * Note that the path /MOODLE_BACKUP/COURSE/MODULES/MOD/DATAC does not
    ...
    public function get_paths() {
        return array(
            new convert_path('datac', '/MOODLE_BACKUP/COURSE/MODULES/MOD/DATAC',
                        array(
                            'newfields' => array(
                                'introformat' => 0,
                                'assesstimestart' => 0,
            ...
            new convert_path('datac_field', '/MOODLE_BACKUP/COURSE/MODULES/MOD/DATAC/FIELDS/FIELD')
        );
    }

    /**
     * This is executed every time we have one /MOODLE_BACKUP/COURSE/MODULES/MOD/DATAC
     * data available
     */
    public function process_datac($data) {
        global $CFG;
        ...
        $this->fileman = $this->converter->get_file_manager($contextid, 'mod_datac');
        ...
        $this->xmlwriter->begin_tag('activity', array('id' => $instanceid, 'moduleid' => $this->moduleid,
            'modulename' => 'datac', 'contextid' => $contextid));
        $this->xmlwriter->begin_tag('datac', array('id' => $instanceid));
    ...
    /**
     * This is executed every time we have one /MOODLE_BACKUP/COURSE/MODULES/MOD/DATAC/FIELDS/FIELD
     * data available
     */
    public function process_datac_field($data) {
        // process database fields
        $this->write_xml('field', $data, array('/field/id'));
    }

    /**
     * This is executed every time we have one /MOODLE_BACKUP/COURSE/MODULES/MOD/DATAC/RECORDS/RECORD
     * data available
     */
    public function process_datac_record($data) {
        //@todo process user data, and define the convert path in get_paths() above.
        //$this->write_xml('record', $data, array('/record/id'));
    }

    /**
     * This is executed when we reach the closing </MOD> tag of our 'datac' path
     */
    public function on_data_end() {
        // finish writing data.xml
        $this->xmlwriter->end_tag('fields');
        $this->xmlwriter->end_tag('datac');
