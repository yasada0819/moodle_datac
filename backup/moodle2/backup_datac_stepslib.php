 ...
 */
class backup_datac_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $data = new backup_nested_element('datac', array('id'), array(
        ...
        // Define sources
        $data->set_source_table('datac', array('id' => backup::VAR_ACTIVITYID));
        ...
        if ($userinfo) {
            $record->set_source_table('datac_records', array('dataid' => backup::VAR_PARENTID));

            $content->set_source_table('datac_content', array('recordid' => backup::VAR_PARENTID));

            $rating->set_source_table('rating', array('contextid'  => backup::VAR_CONTEXTID,
                                                      'itemid'     => backup::VAR_PARENTID,
                                                      'component'  => backup_helper::is_sqlparam('mod_datac'),
            ...
            if (core_tag_tag::is_enabled('mod_datac', 'datac_records')) {
                $tag->set_source_sql('SELECT t.id, ti.itemid, t.rawname
                    ...
                    backup_helper::is_sqlparam('datac_records'),
                    backup_helper::is_sqlparam('mod_datac'),
        ...
        $data->annotate_files('mod_datac', 'intro', null); // This file area hasn't itemid
        $content->annotate_files('mod_datac', 'content', 'id'); // By content->id
