...
/**
 * The mod_datac field created event.
 *
 * @package    mod_datac
 * @since      Moodle 2.7
...
/**
 * The mod_datac field created event class.
 *
...
class field_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventfieldcreated', 'mod_datac');
    }
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'datac', 'fields add', 'field.php?d=' . $this->other['dataid'] . '&amp;mode=display&amp;fid=' .
