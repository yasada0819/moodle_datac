...
/**
 * The mod_datac field deleted event.
 *
 * @package    mod_datac
...
/**
 * The mod_datac field deleted event class.
 *
...
class field_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventfielddeleted', 'mod_datac');
    }
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'datac', 'fields delete', 'field.php?d=' . $this->other['dataid'],
