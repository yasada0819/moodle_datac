...
/**
 * The mod_datac record created event.
 *
 * @package    mod_datac
...
/**
 * The mod_datac record created event class.
 *
...
class record_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventrecordcreated', 'mod_datac');
    }
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'datac', 'add', 'view.php?d=' . $this->other['dataid'] . '&amp;rid=' . $this->objectid,
