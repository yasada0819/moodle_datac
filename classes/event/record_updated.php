...
/**
 * The mod_datac record updated event.
 *
 * @package    mod_datac
...
/**
 * The mod_datac record updated event class.
 *
...
class record_updated extends \core\event\base {
    ...
    protected function init() {
        $this->data['objecttable'] = 'datac_records';
        $this->data['crud'] = 'u';
    ...
    public static function get_name() {
        return get_string('eventrecordupdated', 'mod_datac');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/datac/view.php', array('d' => $this->other['dataid'], 'rid' => $this->objectid));
    }
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'datac', 'update', 'view.php?d=' . $this->other['dataid'] . '&amp;rid=' . $this->objectid,
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'datac_records', 'restore' => 'datac_record');
    }
