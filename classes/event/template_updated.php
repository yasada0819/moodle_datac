...
/**
 * The mod_datac template updated event.
 *
 * @package    mod_datac
...
/**
 * The mod_datac template updated event class.
 *
...
class template_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventtemplateupdated', 'mod_datac');
    }
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'datac', 'templates saved', 'templates.php?id=' . $this->contextinstanceid .
    ...
    public function get_url() {
        return new \moodle_url('/mod/datac/templates.php', array('d' => $this->other['dataid']));
    }
