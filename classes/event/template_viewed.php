...
/**
 * The mod_datac template viewed event.
 *
 * @package    mod_datac
...
/**
 * The mod_datac template viewed event class.
 *
...
class template_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventtemplateviewed', 'mod_datac');
    }
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'datac', 'templates view', 'templates.php?id=' . $this->contextinstanceid .
