...
$functions = array(
    ...
    'mod_datac_get_databases_by_courses' => array(
        'classname' => 'mod_datac_external',
        ...
        'type' => 'read',
        'capabilities' => 'mod/datac:viewentry',
        'services' => array(MOODLE_OFFICIAL_MOBILE_SERVICE)
    ),
    'mod_datac_view_database' => array(
        'classname'     => 'mod_datac_external',
    ...
    'mod_datac_get_data_access_information' => array(
        'classname'     => 'mod_datac_external',
    ...
    'mod_datac_search_entries' => array(
        'classname'     => 'mod_datac_external',
    ...
    'mod_datac_approve_entry' => array(
        'classname'     => 'mod_datac_external',
        'methodname'    => 'approve_entry',
        'description'   => 'Approves or unapproves an entry.',
        'type'          => 'write',
        'capabilities'  => 'mod/datac:approve',
        'services'      => array(MOODLE_OFFICIAL_MOBILE_SERVICE)
    ),
    'mod_datac_delete_entry' => array(
        'classname'     => 'mod_datac_external',
        'methodname'    => 'delete_entry',
        'description'   => 'Deletes an entry.',
        'type'          => 'write',
        'capabilities'  => 'mod/datac:manageentries',
        'services'      => array(MOODLE_OFFICIAL_MOBILE_SERVICE)
    ),
    'mod_datac_add_entry' => array(
        'classname'     => 'mod_datac_external',
        'methodname'    => 'add_entry',
        'description'   => 'Adds a new entry.',
        'type'          => 'write',
        'capabilities'  => 'mod/datac:writeentry',
        'services'      => array(MOODLE_OFFICIAL_MOBILE_SERVICE)
    ),
    'mod_datac_update_entry' => array(
        'classname'     => 'mod_datac_external',
