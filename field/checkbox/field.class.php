...
class datac_field_checkbox extends datac_field_base {
    ...
    function display_add_field($recordid = 0, $formdata = null) {
        ...
        foreach (explode("\n", $this->field->param1) as $checkbox) {
            ...
            $str .= 'value="' . s($checkbox) . '" class="mod-datac-input m-r-1" ';
    ...
    function display_search_field($value='') {
        ...
        $requiredstr = get_string('selectedrequired', 'datac');
    ...
    function update_content($recordid, $value, $name='') {
        ...
        $content->content = $this->format_datac_field_checkbox_content($value);
    ...
    function format_datac_field_checkbox_content($content) {
        if (!is_array($content)) {
            return NULL;
        }
        $options = explode("\n", $this->field->param1);
