...
class datac_field_file extends datac_field_base {
    var $type = 'file';
    ...
    function display_add_field($recordid = 0, $formdata = null) {
        ...
        $html .= '<div class="mod-datac-input">';
    ...
    function update_content($recordid, $value, $name='') {
        ...
        $files = $fs->get_area_files($this->context->id, 'mod_datac', 'content', $content->id, 'itemid, filepath, filename', false);
        ...
        if (count($files) == 0) {
            ...
            if (count($files) > 1) {
                ...
                debugging('more then one file found in mod_datac instance {$this->data->id} file field (field id: {$this->field->id}) area during update data record {$recordid} (content id: {$content->id})', DEBUG_NORMAL);
            }
        }
