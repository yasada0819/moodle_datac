...
class datac_field_latlong extends datac_field_base {
    var $type = 'latlong';
    ...
    var $linkoutservices = array(
          ...
          "Google Earth" => "@wwwroot@/mod/datac/field/latlong/kml.php?d=@dataid@&fieldid=@fieldid@&rid=@recordid@",
    ...
    function display_add_field($recordid = 0, $formdata = null) {
        ...
        $classes = 'mod-datac-input form-control-static';
        $str .= '<label for="field_'.$this->field->id.'_0" class="' . $classes . '">' . get_string('latitude', 'datac');
        ...
        $str .= get_string('longitude', 'datac');
        if ($this->field->required) {
            $str .= $OUTPUT->pix_icon('req', get_string('requiredelement', 'form'));
        }
        $classes = 'form-control m-x-1';
    ...
    function display_search_field($value = '') {
        ...
        $return = html_writer::label(get_string('latlong', 'datac'), 'menuf_'.$this->field->id, false, $classes);
        $classes = array('class' => 'custom-select');
        $return .= html_writer::select($options, 'f_'.$this->field->id, $value, array('' => get_string('menuchoose', 'datac')),
            $classes);
       return $return;
    }
    ...
    public function field_validation($values) {
        ...
        return get_string('latlongboth', 'datac');
    }
