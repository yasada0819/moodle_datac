...
/**
 * Privacy Subsystem implementation for datacfield_multimenu.
 *
 * @package    datacfield_multimenu
 * @copyright  2018 Carlos Escobedo <carlos@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
namespace datacfield_multimenu\privacy;
use core_privacy\local\request\writer;
use mod_datac\privacy\datacfield_provider;

defined('MOODLE_INTERNAL') || die();
/**
 * Privacy Subsystem for datacfield_multimenu implementing null_provider.
 *
 * @copyright  2018 Carlos Escobedo <carlos@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
