...
class datac_field_multimenu extends datac_field_base {
    ...
    function display_add_field($recordid = 0, $formdata = null) {
        ...
        $str .= ' multiple="multiple" class="mod-datac-input form-control">';
    ...
    function display_search_field($value = '') {
        ...
        $str .= html_writer::checkbox('f_'.$this->field->id.'_allreq', null, $allrequired,
            get_string('selectedrequired', 'datac'), array('class' => 'm-r-1'));
    ...
    function update_content($recordid, $value, $name='') {
        ...
        $content->content  = $this->format_datac_field_multimenu_content($value);
    ...
    function format_datac_field_multimenu_content($content) {
        if (!is_array($content)) {
            return NULL;
        }
        $options = explode("\n", $this->field->param1);
