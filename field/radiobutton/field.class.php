...
class datac_field_radiobutton extends datac_field_base {
    ...
    function display_add_field($recordid = 0, $formdata = null) {
        ...
        if ($formdata) {
            ...
            $content = trim($DB->get_field('datac_content', 'content', array('fieldid'=>$this->field->id, 'recordid'=>$recordid)));
        } else {
            $content = '';
        }
        ...
        foreach ($options as $radio) {
            ...
            $str .= 'value="' . s($radio) . '" class="mod-datac-input m-r-1" ';
