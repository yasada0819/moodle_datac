...
/**
 * Privacy Subsystem implementation for datacfield_text.
 *
 * @package    datacfield_text
 * @copyright  2018 Carlos Escobedo <carlos@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
namespace datacfield_text\privacy;
use core_privacy\local\request\writer;
use mod_datac\privacy\datacfield_provider;

defined('MOODLE_INTERNAL') || die();
/**
 * Privacy Subsystem for datacfield_text implementing null_provider.
 *
 * @copyright  2018 Carlos Escobedo <carlos@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
