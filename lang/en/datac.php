...
/**
 * Strings for component 'datac', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   mod_datac
...
$string['withtime'] = 'with timeadded and timemodified';
$string['withuserdetails'] = 'with user details';
...
$string['modulename'] = 'Database(customized)';
$string['modulename_help'] = 'Database (custom) is based on Moodle\'s standard Database activity module plus a few customs based on it.

When importing data by loading CSV file, it reproduces it including the creator information of the original entry.
';
...
$string['modulename_link'] = 'mod/datac/view';
$string['modulenameplural'] = 'Databases(customized)';
$string['more'] = 'More';
...
$string['page-mod-datac-x'] = 'Any database activity module page';
...
$string['pluginname'] = 'Database(customized)';
...
$string['privacy:metadata:datac_content'] = 'Represents one answer to one field in database activity module';
$string['privacy:metadata:datac_content:fieldid'] = 'Field definition ID';
$string['privacy:metadata:datac_content:content'] = 'Content';
$string['privacy:metadata:datac_content:content1'] = 'Additional content 1';
$string['privacy:metadata:datac_content:content2'] = 'Additional content 2';
$string['privacy:metadata:datac_content:content3'] = 'Additional content 3';
$string['privacy:metadata:datac_content:content4'] = 'Additional content 4';
$string['privacy:metadata:datac_records'] = 'Represent records in database acitivity module';
$string['privacy:metadata:datac_records:userid'] = 'User who created the record';
$string['privacy:metadata:datac_records:groupid'] = 'Group';
$string['privacy:metadata:datac_records:timecreated'] = 'Time when record was created';
$string['privacy:metadata:datac_records:timemodified'] = 'Time when record was last modified';
$string['privacy:metadata:datac_records:approved'] = 'Approval status';
$string['privacy:metadata:datacfieldnpluginsummary'] = 'Fields for database activity module';
...
$string['subplugintype_datacfield'] = 'Database field type';
$string['subplugintype_datacfield_plural'] = 'Database field types';
$string['subplugintype_datacpreset'] = 'Preset';
$string['subplugintype_datacpreset_plural'] = 'Presets';
$string['tagarea_datac_records'] = 'Data records';
$string['tags'] = 'Tags';
...
$string['uploadrecords_link'] = 'mod/datac/import';
$string['url'] = 'Url';
...
// Auto import
$string['csvautoimportconfig'] = 'csv auto-import config';
$string['enableautoimport'] = 'enable auto-import';
$string['csvfilepath'] = 'name for csvfile';
$string['csvfilepath_help'] = 'CSV file name from Moodle\'s data directory (eg moodledata).';
$string['useridfieldname'] = 'name for userid field';
$string['timecreatedfieldname'] = 'name for timecreated field';
$string['timemodifiedfieldname'] = 'name for timemodified field';
$string['fieldwrapper'] = 'field wrapping charactor';
$string['timecreatedformat'] = 'format for timecreated';
$string['timemodifiedformat'] = 'format for timemodified';
$string['date_format_type'] = 'Data type of "date" type field';
$string['autoimporttask'] = 'Auto-Import from CSV file to '.$string['pluginname'].' module';
$string['limittoenrolled'] = 'Import only the data of the user registered in the course';
$string['nothingenablefields'] = 'Nothing enable fields';
$string['groupname'] = 'Name of field with group name';

// errormessage
$string['undefinedfield'] = 'Undefined field. It was ignored.';

// Logging
$string['importlog'] = 'logfile name';
$string['importlog_default'] = 'datac_import.log';
$string['useridnotfound'] = 'userid is not found in moodleDB';
$string['recordserror'] = 'record(s) was not saved. Check logfile.';
