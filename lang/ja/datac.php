...
/**
 * Strings for component 'datac', language 'ja', branch 'MOODLE_35_STABLE'
 *
 * @package   datac
 * @copyright 2018 FUJI-SOFT
...
$string['withtime'] = '追加/修正時間を含む';
$string['withuserdetails'] = 'ユーザ詳細を含む';
...
$string['modulename'] = 'データベース（カスタム）';
$string['modulename_help'] = 'Moodle標準のデータベース活動モジュールをベースに若干のカスタムを加えたものがデータベース（カスタム）です。

CSVファイル読み込みによるデータのインポート時に、元のエントリの作成者の情報を含めて再現します。
';
$string['modulenameplural'] = 'データベース（カスタム）';
$string['more'] = '詳細';
...
$string['page-mod-datac-x'] = 'すべてのデータベース活動ページ';
...
$string['privacy:metadata:datac_content'] = 'データベース活動モジュールでは1つの回答が1つのフィールドを示します。';
$string['privacy:metadata:datac_content:content'] = 'コンテンツです。';
$string['privacy:metadata:datac_content:content1'] = '追加コンテンツ1です。';
$string['privacy:metadata:datac_content:content2'] = '追加コンテンツ2です。';
$string['privacy:metadata:datac_content:content3'] = '追加コンテンツ3です。';
$string['privacy:metadata:datac_content:content4'] = '追加コンテンツ4です。';
$string['privacy:metadata:datac_content:fieldid'] = 'フィールド定義IDです。';
$string['privacy:metadata:datafieldnpluginsummary'] = 'データベース活動モジュールのフィールです。';
$string['privacy:metadata:datac_records'] = 'データベース活動モジュールのレコードを示します。';
$string['privacy:metadata:datac_records:approved'] = '承認ステータスです。';
$string['privacy:metadata:datac_records:groupid'] = 'グループです。';
$string['privacy:metadata:datac_records:timecreated'] = 'レコードが作成された日時です。';
$string['privacy:metadata:datac_records:timemodified'] = 'レコードが最後に修正された日時です。';
$string['privacy:metadata:datac_records:userid'] = 'レコードを作成したユーザです。';
...
$string['tagarea_datac_records'] = 'データレコード';
$string['tags'] = 'タグ';
...
// 自動インポート
$string['csvautoimportconfig'] = 'ＣＳＶ自動取り込み設定';
$string['enableautoimport'] = 'ＣＳＶを自動で取り込む';
$string['csvfilepath'] = 'ＣＳＶファイル名';
$string['csvfilepath_help'] = 'Moodleのデータディレクトリ（例：moodledata）からのＣＳＶファイル名です。';
$string['useridfieldname'] = 'ユーザーＩＤのフィールド名';
$string['timecreatedfieldname'] = '追加日時のフィールド名';
$string['timemodifiedfieldname'] = '修正日時のフィールド名';
$string['fieldwrapper'] = 'ＣＳＶファイルのフィールド囲み文字';
$string['timecreatedformat'] = '追加日時のフォーマット';
$string['timemodifiedformat'] = '修正日時のフォーマット';
$string['date_format_type'] = '日付タイプのフィールドのデータ形式';
$string['autoimporttask'] = $string['pluginname'].' モジュールへのＣＳＶファイルの自動インポート';
$string['limittoenrolled'] = 'コースに登録しているユーザのデータのみインポートする';
$string['nothingenablefields'] = '有効なフィールドがありません';
$string['groupname'] = 'グループ名が記載されたフィールドの名前';

// エラーメッセージ
$string['undefinedfield'] = '未定義のフィールドが無視されました。';

// ロギング
$string['importlog'] = 'ログファイル名';
$string['importlog_default'] = 'datac_import.log';
$string['useridnotfound'] = '対応するユーザがMoodleにありません';
$string['recordserror'] = '件のレコードが追加されませんでした。ログを確認してください。';
