 ...
 * @since      Moodle 2.9
 */
class mod_datac_external_testcase extends externallib_advanced_testcase {
    ...
    public function setUp() {
        ...
        $this->database = $this->getDataGenerator()->create_module('datac', array('course' => $this->course->id));
        $this->context = context_module::instance($this->database->cmid);
        $this->cm = get_coursemodule_from_instance('datac', $this->database->id);
     ...
     */
    public function test_mod_datac_get_databases_by_courses() {
        global $DB;
        ...
        $database1 = self::getDataGenerator()->create_module('datac', $record);

        // Second database.
        $record = new stdClass();
        $record->introformat = FORMAT_HTML;
        $record->course = $course2->id;
        $database2 = self::getDataGenerator()->create_module('datac', $record);
        ...
        $result = mod_datac_external::get_databases_by_courses(array($course2->id, $course1->id));
        $result = external_api::clean_returnvalue(mod_datac_external::get_databases_by_courses_returns(), $result);
        $this->assertEquals($expecteddatabases, $result['databases']);

        // Call the external function without passing course id.
        $result = mod_datac_external::get_databases_by_courses();
        $result = external_api::clean_returnvalue(mod_datac_external::get_databases_by_courses_returns(), $result);
        $this->assertEquals($expecteddatabases, $result['databases']);
        ...
        $result = mod_datac_external::get_databases_by_courses(array($course2->id));
        ...
        $result = mod_datac_external::get_databases_by_courses(array($course1->id));
        $result = external_api::clean_returnvalue(mod_datac_external::get_databases_by_courses_returns(), $result);
        $this->assertEquals($expecteddatabases, $result['databases']);
    }
    ...
    public function test_view_database_invalid_id() {
        ...
        mod_datac_external::view_database(0);
    }
    ...
    public function test_view_database_no_capabilities() {
        ...
        assign_capability('mod/datac:viewpage', CAP_PROHIBIT, $this->studentrole->id, $this->context->id);
    ...
    public function test_view_database() {
        ...
        $result = mod_datac_external::view_database($this->database->id);
        $result = external_api::clean_returnvalue(mod_datac_external::view_database_returns(), $result);
        ...
        $moodledata = new \moodle_url('/mod/datac/view.php', array('id' => $this->cm->id));
    ...
    public function test_get_data_access_information_student() {
        ...
        $DB->update_record('datac', $this->database);

        // Test user with full capabilities.
        $this->setUser($this->student1);

        $result = mod_datac_external::get_data_access_information($this->database->id);
        $result = external_api::clean_returnvalue(mod_datac_external::get_data_access_information_returns(), $result);
    ...
    public function populate_database_with_entries() {
        ...
        // Force approval.
        $DB->set_field('datac', 'approval', 1, array('id' => $this->database->id));
        ...
        $fields = $DB->get_records('datac_fields', array('dataid' => $this->database->id), 'id');
        ...
        $DB->set_field('datac_records', 'approved', 1, ['id' => $entry11]);
        $DB->set_field('datac_records', 'approved', 1, ['id' => $entry12]);
        $DB->set_field('datac_records', 'approved', 1, ['id' => $entry14]);
        $DB->set_field('datac_records', 'approved', 1, ['id' => $entry21]);
    ...
    public function test_get_entries() {
        ...
        $this->setUser($this->student1);
        $result = mod_datac_external::get_entries($this->database->id);
        $result = external_api::clean_returnvalue(mod_datac_external::get_entries_returns(), $result);
        ...
        $entries = $DB->get_records('datac_records', array('dataid' => $this->database->id), 'id');
        ...
        $this->setUser($this->student1);
        $result = mod_datac_external::get_entries($this->database->id, $this->group1->id);
        $result = external_api::clean_returnvalue(mod_datac_external::get_entries_returns(), $result);
        $this->assertCount(0, $result['warnings']);
        $this->assertCount(3, $result['entries']);
        $this->assertEquals(3, $result['totalcount']);
        ...
        $this->setUser($this->student1);
        $result = mod_datac_external::get_entries($this->database->id, $this->group1->id, false, null, 'DESC');
        $result = external_api::clean_returnvalue(mod_datac_external::get_entries_returns(), $result);
        $this->assertCount(0, $result['warnings']);
        $this->assertCount(3, $result['entries']);
        $this->assertEquals(3, $result['totalcount']);
        ...
        // Test pagination.
        $this->setUser($this->student1);
        $result = mod_datac_external::get_entries($this->database->id, $this->group1->id, false, null, null, 0, 1);
        $result = external_api::clean_returnvalue(mod_datac_external::get_entries_returns(), $result);
        $this->assertCount(0, $result['warnings']);
        ...
        $result = mod_datac_external::get_entries($this->database->id, $this->group1->id, false, null, null, 1, 1);
        $result = external_api::clean_returnvalue(mod_datac_external::get_entries_returns(), $result);
        $this->assertCount(0, $result['warnings']);
        $this->assertCount(1, $result['entries']);
        $this->assertEquals(3, $result['totalcount']);
        ...
        datac_generate_default_template($this->database, 'listtemplate', 0, false, true); // Generate a default list template.
        $result = mod_datac_external::get_entries($this->database->id, $this->group1->id, true, null, null, 0, 2);
        $result = external_api::clean_returnvalue(mod_datac_external::get_entries_returns(), $result);
        $this->assertCount(0, $result['warnings']);
        $this->assertCount(2, $result['entries']);
        $this->assertEquals(3, $result['totalcount']);
    ...
    public function test_get_entry_visible_groups() {
        ...
        $this->setUser($this->student1);
        $result = mod_datac_external::get_entry($entry11);
        $result = external_api::clean_returnvalue(mod_datac_external::get_entry_returns(), $result);
        $this->assertCount(0, $result['warnings']);
        ...
        $result = mod_datac_external::get_entry($entry21);
        $result = external_api::clean_returnvalue(mod_datac_external::get_entry_returns(), $result);
        $this->assertCount(0, $result['warnings']);
    ...
    public function test_get_entry_separated_groups() {
        ...
        // Retrieve contents.
        datac_generate_default_template($this->database, 'singletemplate', 0, false, true);
        $result = mod_datac_external::get_entry($entry11, true);
        $result = external_api::clean_returnvalue(mod_datac_external::get_entry_returns(), $result);
        $this->assertCount(0, $result['warnings']);
        ...
        $result = mod_datac_external::get_entry($entry12);
        $result = external_api::clean_returnvalue(mod_datac_external::get_entry_returns(), $result);
        $this->assertCount(0, $result['warnings']);
        ...
        $result = mod_datac_external::get_entry($entry13);
        $result = external_api::clean_returnvalue(mod_datac_external::get_entry_returns(), $result);
    ...
    public function test_get_fields() {
        ...
        $this->setUser($this->student1);
        $result = mod_datac_external::get_fields($this->database->id);
        $result = external_api::clean_returnvalue(mod_datac_external::get_fields_returns(), $result);
    ...
    public function test_search_entries() {
        ...
        $result = mod_datac_external::search_entries($this->database->id, 0, false);
        $result = external_api::clean_returnvalue(mod_datac_external::search_entries_returns(), $result);
        $this->assertCount(3, $result['entries']);
        $this->assertEquals(3, $result['totalcount']);

        // Search for something that does not exists.
        $result = mod_datac_external::search_entries($this->database->id, 0, false, 'abc');
        $result = external_api::clean_returnvalue(mod_datac_external::search_entries_returns(), $result);
        $this->assertCount(0, $result['entries']);
        $this->assertEquals(0, $result['totalcount']);

        // Search by text matching all the entries.
        $result = mod_datac_external::search_entries($this->database->id, 0, false, 'text');
        $result = external_api::clean_returnvalue(mod_datac_external::search_entries_returns(), $result);
        $this->assertCount(3, $result['entries']);
        $this->assertEquals(3, $result['totalcount']);
        ...
        $this->setUser($this->student2);
        $result = mod_datac_external::search_entries($this->database->id, 0, false, 'text', [], DATA_APPROVED, 'ASC');
        $result = external_api::clean_returnvalue(mod_datac_external::search_entries_returns(), $result);
        ...
        // Pagination.
        $this->setUser($this->teacher);
        $result = mod_datac_external::search_entries($this->database->id, 0, false, 'text', [], DATA_TIMEADDED, 'ASC', 0, 2);
        $result = external_api::clean_returnvalue(mod_datac_external::search_entries_returns(), $result);
        ...
        $result = mod_datac_external::search_entries($this->database->id, 0, false, '', $advsearch);
        $result = external_api::clean_returnvalue(mod_datac_external::search_entries_returns(), $result);
        $this->assertCount(2, $result['entries']);
        $this->assertEquals(2, $result['totalcount']);
        $this->assertEquals(3, $result['maxcount']);
        ...
        $field = $DB->get_record('datac_fields', array('type' => 'url'));
        $advsearch = [
        ...
        // Combined search.
        $field2 = $DB->get_record('datac_fields', array('type' => 'number'));
        $advsearch = [
            ['name' => 'f_' . $field->id , 'value' => 'sampleurl'],
    ...
    public function test_approve_entry() {
        ...
        $this->setUser($this->teacher);
        $this->assertEquals(0, $DB->get_field('datac_records', 'approved', array('id' => $entry13)));
        $result = mod_datac_external::approve_entry($entry13);
        $result = external_api::clean_returnvalue(mod_datac_external::approve_entry_returns(), $result);
        $this->assertEquals(1, $DB->get_field('datac_records', 'approved', array('id' => $entry13)));
    }
    ...
    public function test_unapprove_entry() {
        ...
        $this->setUser($this->teacher);
        $this->assertEquals(1, $DB->get_field('datac_records', 'approved', array('id' => $entry11)));
        $result = mod_datac_external::approve_entry($entry11, false);
        $result = external_api::clean_returnvalue(mod_datac_external::approve_entry_returns(), $result);
        $this->assertEquals(0, $DB->get_field('datac_records', 'approved', array('id' => $entry11)));
    }
    ...
    public function test_approve_entry_missing_permissions() {
        ...
        $this->setUser($this->student1);
        $this->expectException('moodle_exception');
        mod_datac_external::approve_entry($entry13);
    }
    ...
    public function test_delete_entry_as_teacher() {
        ...
        $this->setUser($this->teacher);
        $result = mod_datac_external::delete_entry($entry11);
        $result = external_api::clean_returnvalue(mod_datac_external::delete_entry_returns(), $result);
        $this->assertEquals(0, $DB->count_records('datac_records', array('id' => $entry11)));

        // Entry in other group.
        $result = mod_datac_external::delete_entry($entry21);
        $result = external_api::clean_returnvalue(mod_datac_external::delete_entry_returns(), $result);
        $this->assertEquals(0, $DB->count_records('datac_records', array('id' => $entry21)));
    }
    ...
    public function test_delete_entry_as_student_in_read_only_period() {
        ...
        $this->setUser($this->student1);
        $this->expectException('moodle_exception');
        mod_datac_external::delete_entry($entry11);
    }
    ...
    public function test_delete_entry_missing_permissions() {
        ...
        $this->setUser($this->student1);
        $this->expectException('moodle_exception');
        mod_datac_external::delete_entry($entry21);
    }
    ...
    public function test_add_entry() {
        ...
        $result = mod_datac_external::add_entry($this->database->id, 0, $newentrydata);
        $result = external_api::clean_returnvalue(mod_datac_external::add_entry_returns(), $result);

        $newentryid = $result['newentryid'];
        $result = mod_datac_external::get_entry($newentryid, true);
        $result = external_api::clean_returnvalue(mod_datac_external::get_entry_returns(), $result);
        ...
        foreach ($result['entry']['contents'] as $content) {
            ...
            $dbcontent = $DB->get_record('datac_content', array('fieldid' => $field->id, 'recordid' => $newentryid));
        ...
        $this->assertEquals(get_string('errormustsupplyvalue', 'datac'), $result['fieldnotifications'][0]['notification']);
    }
    ...
    public function test_add_entry_empty_form() {
        $result = mod_datac_external::add_entry($this->database->id, 0, []);
        $result = external_api::clean_returnvalue(mod_datac_external::add_entry_returns(), $result);
        $this->assertEquals(0, $result['newentryid']);
        $this->assertCount(1, $result['generalnotifications']);
        $this->assertCount(0, $result['fieldnotifications']);
        $this->assertEquals(get_string('emptyaddform', 'datac'), $result['generalnotifications'][0]);
    }
    ...
    public function test_add_entry_read_only_period() {
        ...
        $this->setUser($this->student1);
        $this->expectExceptionMessage(get_string('noaccess', 'datac'));
        $this->expectException('moodle_exception');
        mod_datac_external::add_entry($this->database->id, 0, []);
    }
    ...
    public function test_update_entry() {
        ...
        $result = mod_datac_external::update_entry($entry11, $newentrydata);
        $result = external_api::clean_returnvalue(mod_datac_external::update_entry_returns(), $result);
        ...
        foreach ($result['entry']['contents'] as $content) {
            $field = $fields[$content['fieldid']];
            // Stored content same that the one retrieved by WS.
            $dbcontent = $DB->get_record('datac_content', array('fieldid' => $field->id, 'recordid' => $entry11));
            $this->assertEquals($dbcontent->content, $content['content']);
    ...
    public function test_update_entry_empty_data() {
        ...
        $this->setUser($this->student1);
        $result = mod_datac_external::update_entry($entry11, []);
        $result = external_api::clean_returnvalue(mod_datac_external::update_entry_returns(), $result);
        $this->assertFalse($result['updated']);
        $this->assertCount(1, $result['generalnotifications']);
    ...
    public function test_update_entry_read_only_period() {
        ...
        $this->expectExceptionMessage(get_string('noaccess', 'datac'));
        $this->expectException('moodle_exception');
        mod_datac_external::update_entry($entry11, []);
    }
    ...
    public function test_get_entry_rating_information() {
        ...
        $DB->set_field('datac', 'assessed', RATING_AGGREGATE_SUM, array('id' => $this->database->id));
        $DB->set_field('datac', 'scale', 100, array('id' => $this->database->id));
        list($entry11, $entry12, $entry13, $entry14, $entry21) = self::populate_database_with_entries();
