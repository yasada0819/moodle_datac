 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_datac_restore_date_testcase extends restore_date_testcase {
    ...
    public function test_restore_dates() {
        ...
        $gg = $this->getDataGenerator()->get_plugin_generator('mod_datac');
        ...
        list($course, $data) = $this->create_course_and_module('datac', $record);
        ...
        $datarecord = $DB->get_record('datac_records', ['id' => $datarecordid]);
        ...
        $newdata = $DB->get_record('datac', ['course' => $newcourseid]);
        ...
        $newdatarecord = $DB->get_record('datac_records', ['dataid' => $newdata->id]);
